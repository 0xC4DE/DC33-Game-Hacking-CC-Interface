...
local computerId = 1003
local puzzle_label = "puzzle4"
...
local function receive_file(data)
    ...
    file.write(data)
    commands.exec(string.format("setblock ~ ~2 ~ computercraft:turtle_advanced[facing=east]{Fuel:50,ComputerId:%i}", computerId))
