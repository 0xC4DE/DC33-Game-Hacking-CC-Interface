...
monitor.clear()
PrimeUI.centerLabel(monitor, 1, 2, x, "Welcome!", colors.black, colors.white)
...
Welcome to the Game Hacking Village!

This lab is focused on a mod called "Computer Craft", you will be solving puzzles based upon a helpful block called the "turtle", which is able to move itself, items, interact with the world, and more!
    
For convenience, writing your scripts in Visual Studio Code is highly, highly recommended. Check GameHacking.gg for more information.

Additionally, you will have to write code in the Lua programming language, which is very commonly used in modding, hacking, and more! Direwolf20 on youtube has an exceptional tutorial outlining how to use computercraft and lua.

There's plenty of places to look online, each task will have little hints as to how to solve them.

The API for turtles can be found at https://tweaked.cc]], false, colors.black, colors.white)
PrimeUI.run()